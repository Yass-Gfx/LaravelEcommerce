        ...
        <div class="row d-flex align-items-center">
            <div class="contentsticky_verticalmenu verticalmenu-main col-lg-3 col-md-1 d-flex"
                ...
                <div class="verticalmenu-content has-showmore show">
                    ...
                    <div id="_desktop_verticalmenu" class="nov-verticalmenu" data-count_showmore="6">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        ...
                                                                        <li><a href="#" title="Lenovo Yoga">Lenovo
                                                                                Yoga</a></li>
                                                                        <li><a href="#" title="Probook">Probook</a>
                                                                        </li>
                                                            ...
                                                            <li class="item col-lg-3 col-md-3 html"><span
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        ...
                                                                        <li><a href="#" title="Xiaomi ">Xiaomi </a>
                                                                        </li>
                                                                        <li><a href="#" title="Huawei ">Huawei </a>
                                                                        </li>
